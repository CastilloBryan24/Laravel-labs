                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="src" class="col-md-4 col-form-label text-md-right">{{ __('Photo') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('fonction') is-invalid @enderror" id="fonction" name="fonction_id">
